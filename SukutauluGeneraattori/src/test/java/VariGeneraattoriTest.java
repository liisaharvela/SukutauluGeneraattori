...
public class VariGeneraattoriTest {
    ...
    @Test
    public void varigeneraattoriGeneroiErikoisvarin() {
        String vari = VariGeneraattori.salliErikoisVarit();
        assertEquals(vari.length(), vari.length() != 0);
    }

    @Test
    public void varigeneraattoriGeneroiKirjavan() {
        String vari = VariGeneraattori.salliKirjavat();
        assertEquals(vari.length(), vari.length() != 0);
    }
